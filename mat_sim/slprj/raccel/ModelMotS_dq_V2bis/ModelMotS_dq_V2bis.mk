...
MODEL                  = ModelMotS_dq_V2bis
MODULES                = rt_logging.c ModelMotS_dq_V2bis.c ModelMotS_dq_V2bis_capi.c ModelMotS_dq_V2bis_data.c ModelMotS_dq_V2bis_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = ModelMotS_dq_V2bis.mk
...
COMPUTER               = GLNXA64
BUILDARGS              =  MODELLIB=ModelMotS_dq_V2bislib.a RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2018b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/ModelMotS_dq_V2bis \
