...
) , TARGET_STRING ( "" ) , 0 , 1 , 1 , 0 , 4 } , { 20 , 6 , TARGET_STRING (
...
0 } , { 22 , TARGET_STRING ( "ModelMotS_dq_V2/Reference Speed (rad//s)" ) ,
TARGET_STRING ( "rep_seq_y" ) , 0 , 2 , 0 } , { 23 , TARGET_STRING (
"ModelMotS_dq_V2/Pulse Generator2" ) , TARGET_STRING ( "Amplitude" ) , 0 , 1
, 0 } , { 24 , TARGET_STRING ( "ModelMotS_dq_V2/Pulse Generator2" ) ,
TARGET_STRING ( "PulseWidth" ) , 0 , 1 , 0 } , { 25 , TARGET_STRING (
"ModelMotS_dq_V2/Pulse Generator2" ) , TARGET_STRING ( "PhaseDelay" ) , 0 , 1
, 0 } , { 26 , TARGET_STRING ( "ModelMotS_dq_V2/Constant Load System2/Gain" )
...
"BreakpointsForDimension1" ) , 0 , 2 , 0 } , { 29 , TARGET_STRING (
...
"BreakpointsForDimension1" ) , 0 , 2 , 0 } , { 31 , TARGET_STRING (
...
TARGET_STRING ( "Gain" ) , 0 , 1 , 0 } , { 33 , TARGET_STRING (
"ModelMotS_dq_V2/UF control _ dqframe/UF control/Unit Delay2" ) ,
TARGET_STRING ( "InitialCondition" ) , 0 , 1 , 0 } , { 34 , TARGET_STRING (
 "ModelMotS_dq_V2/Induction Motor  Electrical Part d,q/Non Linear Magnetic Coupling/f/Gain3"
 ...
 "ModelMotS_dq_V2/Induction Motor  Electrical Part d,q/Non Linear Magnetic Coupling/g_1/Gain5"
) , TARGET_STRING ( "Gain" ) , 0 , 1 , 0 } , { 37 , TARGET_STRING (
...
40 , TARGET_STRING ( "J" ) , 0 , 1 , 0 } , { 41 , TARGET_STRING ( "Lfr" ) , 0
, 1 , 0 } , { 42 , TARGET_STRING ( "Lfs" ) , 0 , 1 , 0 } , { 43 ,
TARGET_STRING ( "Lmt" ) , 0 , 1 , 0 } , { 44 , TARGET_STRING ( "Lr" ) , 0 , 1
, 0 } , { 45 , TARGET_STRING ( "P1" ) , 0 , 1 , 0 } , { 46 , TARGET_STRING (
"P2" ) , 0 , 1 , 0 } , { 47 , TARGET_STRING ( "Prinit" ) , 0 , 0 , 0 } , { 48
, TARGET_STRING ( "Psdnom" ) , 0 , 1 , 0 } , { 49 , TARGET_STRING ( "Psinit"
) , 0 , 0 , 0 } , { 50 , TARGET_STRING ( "Rr" ) , 0 , 1 , 0 } , { 51 ,
TARGET_STRING ( "Rs" ) , 0 , 1 , 0 } , { 52 , TARGET_STRING ( "Ts" ) , 0 , 1
, 0 } , { 53 , TARGET_STRING ( "Ulim" ) , 0 , 1 , 0 } , { 54 , TARGET_STRING
( "Uo" ) , 0 , 1 , 0 } , { 55 , TARGET_STRING ( "np" ) , 0 , 1 , 0 } , { 56 ,
TARGET_STRING ( "tauL" ) , 0 , 1 , 0 } , { 57 , TARGET_STRING ( "thrinit" ) ,
0 , 1 , 0 } , { 58 , TARGET_STRING ( "wL" ) , 0 , 1 , 0 } , { 59 ,
TARGET_STRING ( "wrinit" ) , 0 , 1 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . oussmmuoy4 [ 0 ] , & rtB .
awofsj5yej , & rtB . lbn1yidduk , & rtB . n5nk0fcdxe , & rtB . dxxqwldjss [ 0
] , & rtB . lrfbty4a0y [ 0 ] , & rtB . ohojx4cexj , & rtB . g50obrftrn , &
rtB . agjnm01x4l , & rtB . llcuyb21kn , & rtB . awofsj5yej , & rtB .
c40hosfmrc , & rtB . its0a3zvwu [ 0 ] , & rtB . lfrpqznzmd , & rtB .
aa0ktk1lsw , & rtB . czrf0nwdxd , & rtB . oleotyrvsj , & rtB . pzn3ntwo0f , &
rtB . kywwenqxru , & rtB . k4xamhzsst , & rtB . oussmmuoy4 [ 0 ] , & rtP .
...
Constant_Value_jaivf4zt3q , & rtP . LookUpTable1_bp01Data_jgw1iq0tw2 [ 0 ] ,
& rtP . Constant_Value_dn2cyv14tz , & rtP . LookUpTable1_bp01Data [ 0 ] , &
...
2 , 1 , 1 , 1 , 1 , 12000 } ; static const real_T rtcapiStoredFloats [ ] = {
...
( NULL ) , 3 , 0 } , { ( const void * ) & rtcapiStoredFloats [ 1 ] , ( const
void * ) & rtcapiStoredFloats [ 2 ] , 1 , 0 } } ; static
rtwCAPI_ModelMappingStaticInfo mmiStatic = { { rtBlockSignals , 21 , ( NULL )
, 0 , ( NULL ) , 0 } , { rtBlockParameters , 19 , rtModelParameters , 20 } ,
{ ( NULL ) , 0 } , { rtDataTypeMap , rtDimensionMap , rtFixPtMap ,
rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float" , { 3900505454U
, 3953980274U , 2949447938U , 2506987305U } , ( NULL ) , 0 , 0 } ; const
