...
w = csv.writer(open('../datasets/ann_torque.log','wb'))
...
for epoch in range(200):
    ...
    if epoch % 10 == 0:
        for exp in experiment_samples.keys()[14:]:
            ...
            plt.savefig('../datasets/results_ann/torque_' + exp + '_epoch' + str(epoch) + '_true.png')
            plt.close()
            plt.plot(pred_curr1)
            plt.savefig('../datasets/results_ann/torque_' + exp + '_epoch' + str(epoch) + '_pred.png')
            plt.close()
