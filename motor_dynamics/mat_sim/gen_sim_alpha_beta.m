...
save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/Voltage.mat'), 'voltage');
save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/Current.mat'), 'current');
save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/Torque.mat'), 'torque');
save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/Speed.mat'), 'speed');
% save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/StatorPuls.mat'), 'statorPuls');
save(strcat('./motor_control/datasets/synth_simulink/simulink_output/AlphaBeta_Exp', int2str(i), '/Time.mat'), 'time');
